...
const Navbar = (props: Props) => {
  return (
    <div className="fixed top-0 flex md:flex-row flex-col justify-between w-screen py-3 px-3 border border-b-1 border-opacity-20 border-gray-600 bg-white mb-14 items-center z-10 ">
